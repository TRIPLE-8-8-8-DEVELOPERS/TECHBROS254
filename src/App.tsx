...
function App() {
  ...
  console.log("App component mounted, current route:", currentRoute);
  const shouldCenter = !["/dashboard", "/profile", "/messages", "/meetings", "/billing", "/analytics", "/documents", "/settings"].includes(currentRoute);
  const shouldRenderSidebar = ["/dashboard", "/profile"].includes(currentRoute);
      ...
      <ThemeProvider defaultTheme="light">
        <SupabaseProvider>
          <AuthProvider>
            <Router>
              <ScrollToTop />
              <div id="root" className={shouldCenter ? "" : "no-center"}>
