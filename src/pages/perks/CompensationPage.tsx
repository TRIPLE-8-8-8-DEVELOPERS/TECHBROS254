        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Competitive Compensation</h1>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="prose prose-lg max-w-none">
                ...
                <div className="my-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-gray-50 p-8 rounded-xl border border-gray-100">
                    <div className="w-12 h-12 bg-tech-100 rounded-lg flex items-center justify-center mb-4">
                      <TrendingUp size={24} className="text-tech-600" />
                    </div>
                    <h3 className="text-xl font-semibold mb-3">Competitive Base Salary</h3>
                  ...
                  <div className="bg-gray-50 p-8 rounded-xl border border-gray-100">
                    <div className="w-12 h-12 bg-tech-100 rounded-lg flex items-center justify-center mb-4">
                      <BadgePercent size={24} className="text-tech-600" />
                    </div>
                  ...
                  <div className="bg-gray-50 p-8 rounded-xl border border-gray-100">
                    <div className="w-12 h-12 bg-tech-100 rounded-lg flex items-center justify-center mb-4">
                      <Award size={24} className="text-tech-600" />
                    </div>
                    <h3 className="text-xl font-semibold mb-3">Equity Options</h3>
                    <p className="text-gray-600">
                  ...
                  <div className="bg-gray-50 p-8 rounded-xl border border-gray-100">
                    <div className="w-12 h-12 bg-tech-100 rounded-lg flex items-center justify-center mb-4">
                      <Wallet size={24} className="text-tech-600" />
                    </div>
                    <h3 className="text-xl font-semibold mb-3">Regular Salary Reviews</h3>
                    <p className="text-gray-600">
                  ...
                  <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 md:col-span-2">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Comprehensive Benefits Package</h3>
                    <p className="text-gray-600">
                ...
                <h2 className="text-2xl font-bold mt-12 mb-6">Transparent Compensation Structure</h2>
                ...
                <div className="bg-tech-50 p-8 rounded-xl my-12">
                  <h3 className="text-xl font-semibold mb-4">Our Commitment to Pay Equity</h3>
                  <p className="mb-4">
