  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24">
        {/* Hero Section */}
        <section 
          className="relative py-20 bg-gradient-to-br from-indigo-700/90 to-indigo-900/90 text-white"
          style={{
        ...
        >
          <div className="container mx-auto px-4">
            <div className={`max-w-3xl mx-auto text-center transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">AI & Data Services</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            {allSubcategories.length > 0 && (
              <div className="mt-20">
                <h2 className="text-3xl font-bold mb-10 text-center">Specialized AI & Data Services</h2>
                  ...
                  {allSubcategories.map((subcategory, index) => {
                    ...
                    return (
                      <Link 
                        ...
                        className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-indigo-200"
                      >
                        {subcategory.image && (
