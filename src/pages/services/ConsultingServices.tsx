  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24">
        {/* Hero Section */}
        <section 
          className="relative py-20 bg-gradient-to-br from-teal-700/90 to-teal-900/90 text-white"
          style={{
        ...
        >
          <div className="container mx-auto px-4">
            <div className={`max-w-3xl mx-auto text-center transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <Link to="/services" className="text-teal-200 hover:text-white mb-4 inline-flex items-center">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            {allSubcategories.length > 0 && (
              <div className="mt-20">
                <h2 className="text-3xl font-bold mb-10 text-center">Specialized Consulting Services</h2>
                  ...
                  {allSubcategories.map((subcategory, index) => {
                    ...
                    return (
                      <Link 
                        ...
                        className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-teal-200"
                      >
                        {subcategory.image && (
                        ...
                        <div className="p-6">
                          <div className="flex items-center mb-3">
                            {Icon && (
                              <div className="w-8 h-8 rounded-lg bg-teal-50 text-teal-500 flex items-center justify-center mr-3 group-hover:bg-teal-100 transition-colors">
                                <Icon size={18} />
                              </div>
                            )}
