...
const ServicesPage = () => {
  ...
  const categoryIcons = {
    ...
    "Trading Education": <Clock className="w-10 h-10" />
  };
  ...
  const categoryUrls = {
    ...
    "Security": "security",
    "Marketing": "marketing",
    "Trading Education": "forex-trading"
  };
  ...
  const categoryGradients = {
    ...
    "Trading Education": "from-vibrant-purple/10 to-vibrant-blue/5"
  };
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1920px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
              {categories.map((category, index) => (
                ...
                >
                  <div className="p-8">
                    <div className={`w-20 h-20 bg-gradient-to-r ${categoryGradients[category as keyof typeof categoryGradients] || 'from-tech-50 to-white'} rounded-2xl flex items-center justify-center mb-6 text-tech-500 dark:text-white group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className="mb-6 flex flex-wrap gap-2">
                      {serviceDetails
                        ...
                        .slice(0, 3)
                        .map((service, idx) => (
                          <Badge key={idx} variant="outline" className="bg-tech-50 dark:bg-dark-200 text-tech-600 dark:text-gray-200 py-1.5">
                            {service.title}
                          </Badge>
                        ))}
                      {categoryCount[category] > 3 && (
                        <Badge variant="outline" className="bg-gray-100 dark:bg-dark-200 text-gray-700 dark:text-gray-300 py-1.5">
                          +{categoryCount[category] - 3} more
                        </Badge>
                      )}
                    </div>
                    
                    <div className="flex items-center text-vibrant-purple dark:text-vibrant-purple/90 font-medium group-hover:text-vibrant-purple/80 transition-colors">
